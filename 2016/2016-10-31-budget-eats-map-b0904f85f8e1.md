...
https://gist.github.com/jayagonoy/b7adf411676829356fe8796e8b47dba1#file-mallofasia-geojson
...
```
{  "type": "FeatureCollection",  "features": [    {      "type": "Feature",      "properties": {        "marker-color": "#7e7e7e",        "marker-size": "medium",        "marker-symbol": "star-stroked",        "name": "KFC",        "offering": "Flavor Shots a la carte, Php50"      },      "geometry": {        "type": "Point",        "coordinates": [          -239.01712238788605,          14.534527915006434        ]      }    }  ]}
```
...
_That will be for me now — but I do hope to see you next weekend (November 10 to 13 to be exact) at the Kabuhayan Expo at SM Megatrade Hall 1, featuring local products. See you there!_
